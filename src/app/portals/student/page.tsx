...
export default function StudentPortalPage(): React.ReactNode {
  return (
    <>
      <main>
        {/* Page banner */}
          ...
          <div className="container position-relative" style={{ marginTop: '-150px' }}>
            <div className="row">
              <div className="col-12">
                ...
                >
                  <h1 className="mb-3">Student Portal</h1>
                  <nav aria-label="breadcrumb">
                    <ol className="breadcrumb justify-content-center mb-0">
                      <li className="breadcrumb-item"><Link href="/">Home</Link></li>
                      <li className="breadcrumb-item"><Link href="/portals">Portals</Link></li>
                      <li className="breadcrumb-item active" aria-current="page">Student Portal</li>
                    </ol>
                  </nav>
                </motion.div>
              </div>
            ...
            <div className="row justify-content-center">
              <div className="col-lg-8 text-center">
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <h2 className="section-title mb-4">Student Resources</h2>
                  <p className="lead mb-0">
                    Access all the digital tools and resources you need for your academic journey at LMMU.
                    These platforms provide support for learning, research, and administrative processes.
                  </p>
                </motion.div>
              </div>
            </div>
            ...
            <div className="row justify-content-center">
              <div className="col-lg-8 text-center mb-5">
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <h2 className="section-title mb-4">Student Tutorials</h2>
                  <p className="lead mb-0">
            ...
            <div className="row justify-content-center">
              <div className="col-lg-8 text-center">
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <h2 className="section-title mb-4">How to Connect to WIFI</h2>
                  <p className="lead mb-4">
                    Follow our step-by-step guide to connect to the university WiFi network.
                  </p>
                  <a 
