            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    ...
                    <div class="col-md-7 align-self-center">
                        <a href="update.php" class="btn waves-effect waves-light btn btn-info pull-right hidden-sm-down text-white">Update Voters List</a>
                    </div>
                </div>
                <!-- ============================================================== -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle">Total No. Voters <h3 style="color:green;"><?php echo($voters);?></h3></h6>
