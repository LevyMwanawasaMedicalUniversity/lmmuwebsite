...
while ($row2 = $countresult->fetch_assoc()) {
    $users = $row2['Total'];
}
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    ...
                    <div class="col-md-7 align-self-center">
                        <a href="create.php" class="btn waves-effect waves-light btn btn-info pull-right hidden-sm-down text-white">Create User</a>
                    </div>
                </div>
                <!-- ============================================================== -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle">Total No. Voters <h3 style="color:green;"><?php echo($users);?></h3></h6>
